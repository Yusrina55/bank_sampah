...
class DetailPetugasMahasiswa extends StatefulWidget {
  final ScheduleModel schedule;
  final bool isHistory;
  final VoidCallback onBack;

  const DetailPetugasMahasiswa({
    super.key,
  ...
  @override
  State<DetailPetugasMahasiswa> createState() =>
      _DetailPetugasMahasiswaPageState();
}

class _DetailPetugasMahasiswaPageState
    extends State<DetailPetugasMahasiswa> {
